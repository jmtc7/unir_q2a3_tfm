...
- **Entrega 1**: 15 de abril de 2026
- **Entrega 2**: 13 de mayo de 2026
- **Entrega 3**: 17 de junio de 2026
- **Predepósito** (convocatoria ordinaria): 15 de julio de 2026
- **Predepósito** (convocatoria extraordinaria): 9 de septiembre de 2026

Rosa Angélica Gudiño Morales será la tutora de TFM. Podemos contactar con ella a través del foro o a través del correo interno de la UNIR.

En la sección *Temas* del campus virtual encontraremos archivos con las **reglas a seguir**, incluyendo una `plantilla_individual` con una **guía de estilo**.
...
- Evaluar el valor del sistema en un caso representativo de entorno real como logística, mantenimiento, retail, inspección técnica o servicios de campo.
